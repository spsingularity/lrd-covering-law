...
\usepackage{booktabs}
%% Relax float placement so the full-width figure*/deluxetable queue in
%% twocolumn mode does not leave a float stuck (all figures are top-anchored).
...
line-ratio-space objective the nearest competitor sits at joint $\simeq32$
versus 11.5 (Table~\ref{tab:elimination}), with a non-monotonic profile
in $\gamma$ reflecting selection reshuffling between laws. Covering odds
...
(10.4, 86.2, 31.0 at $\gamma=2$, 2.5, 3): changing the law reshuffles
