...
uncertainties accompany the companion paper as an MIT-licensed code archive
(Zenodo DOI to be assigned at submission); the full forward-catalogue grid
is a separate CC-BY-4.0 data record (Zenodo DOI to be assigned). Only public
