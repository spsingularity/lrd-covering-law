...
$z\gtrsim4$ \citep{Matthee2024,Greene2024,Kocevski2025}---show
...
prediction. A model-independent bound is available by cross-depth
reselection: degrading deep public imaging to a survey's shallower depth
and re-running the LRD color gate measures the completeness drift
directly---the same technique that, applied to JADES SED properties,
shows selection bias flips sign at the Balmer break
\citep{PandevXDC}, the wavelength at which the V-shape gate operates.
...
forward-catalogue grid is a separate CC-BY-4.0 data record
(doi:10.5281/zenodo.21476542). Only public data products are used
